...
struct KeyboardShortcut: Codable, Equatable {
    ...
    var isValid: Bool {
        // Requires at least one of Cmd/Option/Control
        let hasCmd = modifierFlags & UInt32(cmdKey) != 0
        let hasOption = modifierFlags & UInt32(optionKey) != 0
        let hasControl = modifierFlags & UInt32(controlKey) != 0
        return hasCmd || hasOption || hasControl
    }
    ...
    static let defaultToggleSidebar = KeyboardShortcut(
